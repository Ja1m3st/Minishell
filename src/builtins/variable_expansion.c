...
static char	*get_var_value(t_mini *mini, char *var_name)
{
	int		i;
	int		arr_len;
	char	*value;
...
static char	*process_regular_char(char *res, char current_char, int *k)
{
	int	len;
...
static char	*add_var_value(t_mini *mini, char *res, char *var_name)
{
	char	*var_value;
	char	*temp;
